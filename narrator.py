...
class Narrator():
    ...
    *note on scenes:  scene1 will be basic intro to story, characters, setting, etc
    ...
    def __init__(self):
        ...
        self.story = '\tThree people found themselves in an unfamiliar house. '
        self.story += 'They did not remember how they got there. We were quite '
        self.story += 'careful in that respect. These three people did not know '
        self.story += 'each other before ending up in this house. The windows '
        self.story += 'and doors were sealed, allowing no escape. We were quite '
        self.story += 'careful in that respect as well. '
        self.story += '\n\tCertain items within the house were flagged by our '
        self.story += 'algorithms as "notable." ' + self.setting.show_contents()
